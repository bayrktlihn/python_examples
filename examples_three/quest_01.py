...
def find_index_begin_alpha(text: str):
    i = -1
    before_letter = " "
...
def find_index_last_alpha(text: str):
    text = text[::-1]
    return (len(text) - 1) - find_index_begin_alpha(text)
...
def middlestrip(text: str):
    ...
    begin_index = find_index_begin_alpha(text)
    end_index = find_index_last_alpha(text)
